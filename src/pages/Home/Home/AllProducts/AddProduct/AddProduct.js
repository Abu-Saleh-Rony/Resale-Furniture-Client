        ...
        fetch(`https://api.imgbb.com/1/upload?key=${imgHostKey}`, {
            ...
            .then((imgData) => {
                if (imgData.success) {
                    ...
                    fetch(" https://resale-furniture-server-abu-saleh-rony.vercel.app/addProduct", {
                        method: "POST",
                        headers: {
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 items-center">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="select select-bordered w-full"
                        >
                            <option value="1">Otobi</option>
                            <option value="2">Hatil</option>
                            <option value="3">Akhtar</option>
                        </select>
                    </div>
                    <div>
