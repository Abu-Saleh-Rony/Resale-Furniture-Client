...
const AllProducts = ({ product, setBookProduct }) => {
    ...
    useEffect(() => {
        axios.get(" https://resale-furniture-server-abu-saleh-rony.vercel.app/users").then((data) => {
    ...
    const handleWishList = (item) => {
        fetch(" https://resale-furniture-server-abu-saleh-rony.vercel.app/wishlist", {
            method: "POST",
            headers: {
    ...
    return (
        <div>
            <div className="card w-full glass">
                ...
                <figure>
                    <img className="h-[350px]" src={image_url} alt="Picture!" />
                </figure>
                <div className="card-body">
                    <h2 className="card-title text-3xl">{products_name}</h2>
                    <div className="flex">
