...
const MyProduct = () => {
    ...
    const url = ` https://resale-furniture-server-abu-saleh-rony.vercel.app/myProducts?email=${user?.email}`;
...
//         fetch(` https://resale-furniture-server-abu-saleh-rony.vercel.app/users/seller/${id}`, {
//             method: 'DELETE',
//             headers: {
//                 authorization: `bearer ${localStorage.getItem('accessToken')}`
//             }
...
//         fetch(' https://resale-furniture-server-abu-saleh-rony.vercel.app/advertisedItems', {
//             method: 'POST',
//             headers: {
