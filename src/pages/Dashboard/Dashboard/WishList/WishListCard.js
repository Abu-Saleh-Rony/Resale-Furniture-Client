...
const WishListCard = ({ list, handleRemove }) => {
    const {
        _id,
        image_url,
    ...
    return (
        <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-900 text-gray-100">
            ...
            <ul className="flex flex-col divide-y divide-gray-700">
                <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                    <div className="flex w-full space-x-2 sm:space-x-4">
                        <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src={image_url} alt="Polaroid camera" />
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-sm line-through text-gray-600">{original_price}€</p>
                                </div>
                            </div>
            ...
            <div className="flex justify-end space-x-4">
                <button type="button" className="px-6 py-2 border rounded-md border-violet-400"><Link to="/">Back To Shop</Link>
                </button>
