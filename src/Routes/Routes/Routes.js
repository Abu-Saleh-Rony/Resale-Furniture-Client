...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "/category/:id",
                loader: ({ params }) =>
                    fetch(` https://resale-furniture-server-abu-saleh-rony.vercel.app/category/${params.id}`),
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        loader: ({ params }) =>
                            fetch(` https://resale-furniture-server-abu-saleh-rony.vercel.app/bookings/${params.id}`),
                    },
                    {
